...
import { Github, Code2, DollarSign, Shield, TrendingUp, Zap } from "lucide-react";
          ...
          <div className="text-white space-y-8 lg:pr-12">
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-300">
                Connect your GitHub account and start earning rewards by solving real-world coding challenges. Quality code, instant rewards.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="flex items-start gap-3 p-4 rounded-xl bg-card/10 backdrop-blur-sm border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Browse open bounties and pick challenges that match your skills</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-card/10 backdrop-blur-sm border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Get paid based on code quality and contribution impact</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-card/10 backdrop-blur-sm border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Transparent escrow system ensures you get paid for your work</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-card/10 backdrop-blur-sm border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Grow your developer profile with verified contributions</p>
                </div>
              </div>
            </div>
